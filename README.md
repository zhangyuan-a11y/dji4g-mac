...
让大疆一代 4G 模块（QDC507 / 移远 EG25-G）在 macOS 上**收发短信、4G 上网、当来电提醒**。

插上 USB 就能用，一个菜单栏图标全搞定。

> 先说清楚一条：这个模块**当不了电话用** —— 电话能拨通、能接、能挂，
> 但接通之后两边都听不到声音。这是模块固件自己的行为（真机三组实测确认），
> 不是设置问题、也不是卡的问题。短信、上网、来电提醒完全不受影响。
...
| 打电话 | 菜单栏直接拨号、接听、挂断；**接通后两边听不到声音**（见上方说明） |
